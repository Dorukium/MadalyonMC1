...
import com.madalyonmc.launcher.mod.LocalModFile;
import com.madalyonmc.launcher.mod.ModLoaderType;
import com.madalyonmc.launcher.mod.RemoteMod;
import com.madalyonmc.launcher.mod.RemoteModRepository;
import com.madalyonmc.launcher.mod.curse.CurseForgeRemoteModRepository;
import com.madalyonmc.launcher.mod.modrinth.ModrinthRemoteModRepository;
...
import com.madalyonmc.launcher.util.io.NetworkUtils;
...
import static com.madalyonmc.launcher.ui.FXUtils.ignoreEvent;
import static com.madalyonmc.launcher.ui.FXUtils.onEscPressed;
import static com.madalyonmc.launcher.ui.ToolbarListPageSkin.createToolbarButton2;
                            ...
                            FXUtils.runInFX(() -> {
                                ...
                                button.setOnAction(e -> {
                                    ...
                                    Controllers.navigate(new DownloadPage(
                                            ...
                                            (profile, version, file) -> com.madalyonmc.launcher.ui.download.DownloadPage.download(profile, version, file, "mods")
                                    ));
                                });
