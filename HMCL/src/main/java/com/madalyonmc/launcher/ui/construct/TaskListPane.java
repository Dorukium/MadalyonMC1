 ...
 */
package com.madalyonmc.launcher.ui.construct;
...
import com.madalyonmc.launcher.download.cleanroom.CleanroomInstallTask;
import com.madalyonmc.launcher.download.fabric.FabricAPIInstallTask;
import com.madalyonmc.launcher.download.fabric.FabricInstallTask;
import com.madalyonmc.launcher.download.forge.ForgeNewInstallTask;
import com.madalyonmc.launcher.download.forge.ForgeOldInstallTask;
import com.madalyonmc.launcher.download.game.GameAssetDownloadTask;
import com.madalyonmc.launcher.download.game.GameInstallTask;
import com.madalyonmc.launcher.download.java.mojang.MojangJavaDownloadTask;
import com.madalyonmc.launcher.download.liteloader.LiteLoaderInstallTask;
import com.madalyonmc.launcher.download.neoforge.NeoForgeInstallTask;
import com.madalyonmc.launcher.download.neoforge.NeoForgeOldInstallTask;
import com.madalyonmc.launcher.download.optifine.OptiFineInstallTask;
import com.madalyonmc.launcher.download.quilt.QuiltAPIInstallTask;
import com.madalyonmc.launcher.download.quilt.QuiltInstallTask;
import com.madalyonmc.launcher.game.HMCLModpackInstallTask;
import com.madalyonmc.launcher.java.JavaInstallTask;
import com.madalyonmc.launcher.mod.MinecraftInstanceTask;
import com.madalyonmc.launcher.mod.ModpackInstallTask;
import com.madalyonmc.launcher.mod.ModpackUpdateTask;
import com.madalyonmc.launcher.mod.curse.CurseCompletionTask;
import com.madalyonmc.launcher.mod.curse.CurseInstallTask;
import com.madalyonmc.launcher.mod.mcbbs.McbbsModpackCompletionTask;
import com.madalyonmc.launcher.mod.mcbbs.McbbsModpackExportTask;
import com.madalyonmc.launcher.mod.modrinth.ModrinthCompletionTask;
import com.madalyonmc.launcher.mod.modrinth.ModrinthInstallTask;
...
import com.madalyonmc.launcher.mod.multimc.MultiMCModpackInstallTask;
import com.madalyonmc.launcher.mod.server.ServerModpackCompletionTask;
import com.madalyonmc.launcher.mod.server.ServerModpackExportTask;
import com.madalyonmc.launcher.mod.server.ServerModpackLocalInstallTask;
...
import com.madalyonmc.launcher.util.FXThread;
...
import static com.madalyonmc.launcher.util.Lang.tryCast;
