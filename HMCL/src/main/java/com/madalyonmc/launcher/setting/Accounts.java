...
import com.madalyonmc.launcher.auth.authlibinjector.*;
import com.madalyonmc.launcher.auth.microsoft.MicrosoftAccount;
import com.madalyonmc.launcher.auth.microsoft.MicrosoftAccountFactory;
import com.madalyonmc.launcher.auth.microsoft.MicrosoftService;
import com.madalyonmc.launcher.auth.offline.OfflineAccount;
import com.madalyonmc.launcher.auth.offline.OfflineAccountFactory;
import com.madalyonmc.launcher.auth.yggdrasil.RemoteAuthenticationException;
import com.madalyonmc.launcher.game.OAuthServer;
import com.madalyonmc.launcher.task.Schedulers;
import com.madalyonmc.launcher.util.FileSaver;
import com.madalyonmc.launcher.util.io.JarUtils;
import com.madalyonmc.launcher.util.skin.InvalidSkinException;
...
import static com.madalyonmc.launcher.setting.ConfigHolder.globalConfig;
import static com.madalyonmc.launcher.ui.FXUtils.onInvalidating;
import static com.madalyonmc.launcher.util.Lang.immutableListOf;
import static com.madalyonmc.launcher.util.Lang.mapOf;
import static com.madalyonmc.launcher.util.Pair.pair;
import static com.madalyonmc.launcher.util.gson.JsonUtils.listTypeOf;
import static com.madalyonmc.launcher.util.gson.JsonUtils.mapTypeOf;
