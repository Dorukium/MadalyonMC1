...
import com.madalyonmc.launcher.task.DownloadException;
import com.madalyonmc.launcher.task.GetTask;
...
import com.madalyonmc.launcher.util.InvocationDispatcher;
        ...
        Schedulers.io().execute(() -> {
            try {
                if (TerracottaMetadata.PROVIDER == null)
                    throw new IOException("Unsupported platform: " + com.madalyonmc.launcher.util.platform.Platform.CURRENT_PLATFORM);
