...
import com.madalyonmc.launcher.countly.CrashReport;
import com.madalyonmc.launcher.ui.CrashWindow;
...
public final class CrashReporter implements Thread.UncaughtExceptionHandler {
    ...
    private static final class Hole {
        ...
        static final Pair<String, String>[] SOURCE = (Pair<String, String>[]) new Pair<?, ?>[]{
                ...
                pair("com.madalyonmc.launcher.util.ResourceNotFoundError", i18n("crash.NoClassDefFound")),
