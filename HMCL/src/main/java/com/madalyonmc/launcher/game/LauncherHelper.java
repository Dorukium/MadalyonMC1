 ...
 */
package com.madalyonmc.launcher.game;

import com.jfoenix.controls.JFXButton;
import javafx.stage.Stage;
import com.madalyonmc.launcher.Launcher;
import com.madalyonmc.launcher.auth.*;
import com.madalyonmc.launcher.auth.authlibinjector.AuthlibInjectorDownloadException;
import com.madalyonmc.launcher.download.DefaultDependencyManager;
import com.madalyonmc.launcher.download.DownloadProvider;
import com.madalyonmc.launcher.download.LibraryAnalyzer;
import com.madalyonmc.launcher.download.MaintainTask;
import com.madalyonmc.launcher.download.game.*;
import com.madalyonmc.launcher.java.JavaManager;
import com.madalyonmc.launcher.java.JavaRuntime;
import com.madalyonmc.launcher.launch.*;
import com.madalyonmc.launcher.mod.ModpackCompletionException;
import com.madalyonmc.launcher.mod.ModpackConfiguration;
import com.madalyonmc.launcher.mod.ModpackProvider;
import com.madalyonmc.launcher.setting.*;
import com.madalyonmc.launcher.task.*;
...
import com.madalyonmc.launcher.ui.construct.PromptDialogPane;
import com.madalyonmc.launcher.ui.construct.TaskExecutorDialogPane;
import com.madalyonmc.launcher.util.*;
import com.madalyonmc.launcher.util.i18n.I18n;
import com.madalyonmc.launcher.util.io.FileUtils;
import com.madalyonmc.launcher.util.io.ResponseCodeException;
import com.madalyonmc.launcher.util.platform.*;
import com.madalyonmc.launcher.util.versioning.GameVersionNumber;
import com.madalyonmc.launcher.util.versioning.VersionNumber;
...
import static com.madalyonmc.launcher.util.DataSizeUnit.MEGABYTES;
import static com.madalyonmc.launcher.util.Lang.resolveException;
import static com.madalyonmc.launcher.util.i18n.I18n.i18n;
import static com.madalyonmc.launcher.util.logging.Logger.LOG;
import static com.madalyonmc.launcher.util.platform.Platform.SYSTEM_PLATFORM;
import static com.madalyonmc.launcher.util.platform.Platform.isCompatibleWithX86Java;
